...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mostrarfechacalendar" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c23ddc2d#;
   pragma Export (C, u00001, "mostrarfechacalendarB");
