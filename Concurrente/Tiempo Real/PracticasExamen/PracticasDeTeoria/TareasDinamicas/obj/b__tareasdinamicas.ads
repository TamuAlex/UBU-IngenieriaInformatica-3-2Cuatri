...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_tareasdinamicas" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d3ec3430#;
   pragma Export (C, u00001, "tareasdinamicasB");
   ...
   u00166 : constant Version_32 := 16#4d8d9950#;
